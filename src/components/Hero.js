...
const Hero = () => {
    ...
    return (
      <div className="bg-white text-black flex flex-col md:flex-row items-center justify-center py-10 px-4">
      ...
      <img src={heroImage} alt="Headshot" className="w-full md:w-1/2 max-w-md md:max-w-lg lg:max-w-xl ml-4 mt-0 mb-0 md:mb-0 rounded-[25%]" />
      ...
      <div className="hidden md:flex md:flex-1 justify-center">
        ...
        <div className="md:hidden hero-text-container w-full">
